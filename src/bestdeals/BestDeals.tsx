...
const BestDeals = () => {
  return (
    ...
    <Box className="deals-container">
        ...
        <List>
            <ListItem>
                <img src="https://html.design/demo/diwali/images/watch_screen_01.png" alt=""/>
                <Typography>Product name</Typography>
                <Typography><span>$100.00</span>$169.00</Typography>
                {/* <img src={star} alt="star" className="star-images"/> */}
                <StarIcon className="star-images" />
